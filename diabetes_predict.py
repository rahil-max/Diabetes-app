...
def app(df):
    ...
    bp = st.slider('Blood Pressure' , int(df['Blood_Pressure'].min()) , int(df['Blood_Pressure'].max()))
    insulin = st.slider('Insulin' , int(df['Insulin'].min()) , int(df['Insulin'].max()))
    bmi = st.slider('BMI' , float(df['BMI'].min()) , float(df['BMI'].max()))
    pedigree = st.slider('Pedigree' , float(df['Pedigree_Function'].min()) , float(df['Pedigree_Function'].max()))
